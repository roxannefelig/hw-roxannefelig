---
title: "HW1_Data_Exploring"
author: "Roxanne Felig"
date: "1/24/2021"
output: html_document
---

<!-- You have a couple of different versions of your files here. Please be sure to only keep the final version and its md/html outputs when you finish an assignment. -->
...
```{r penguins structure, echo=TRUE}
str(HW1data)
nrow(HW1data)
ncol(HW1data)
